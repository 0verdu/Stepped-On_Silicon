...
IP Addresses:
172.31.34.114 (primary exfiltration)
172.31.32.1 (VPC gateway)

Ports:
64579 (primary listener)
...
Operational Taiwan Mobile infrastructure within US borders represents a coordinated surveillance platform.
